...
class Function(object):
    def __init__(self, cursor):
        ...
        self.return_values = get_return_values(cursor)
...
if len(sys.argv) != 2:
    print("Usage: emscripten_gen.py [header file name]")
    sys.exit()
...
tpl = Template(filename='bind_xml.mako')
rendered = tpl.render(
             classes=classes,
...
with open("generated/{}.bind.xml".format(sys.argv[1]), "w") as f:
    f.write(rendered)
