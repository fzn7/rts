  ...
  , stayTime(0)
{
    ...
    tracefile << pos.x << " " << pos.y << " " << pos.z << " " << speed.x << " "
              << speed.y << " " << speed.z << "\n";
#endif
}
...
CLaserProjectile::UpdateIntensity()
{
    if (ttl > 0) {
        explGenHandler->GenExplosion(
          cegID, pos, speed, ttl, intensity, 0.0f, NULL, NULL);
        return;
    }
    ...
    if (camDist < weaponDef->visuals.lodDistance) {
        ...
        if (checkCol) { // expanding or contracting?
            ...
            texEndOffset = (1.0f - (curLength / maxLength)) *
                           (weaponDef->visuals.texture1->xstart -
                            weaponDef->visuals.texture1->xend);
        } else {
            texStartOffset = (-1.0f + (curLength / maxLength) +
                              ((float)stayTime * (speedf / maxLength))) *
                             (weaponDef->visuals.texture1->xstart -
                              weaponDef->visuals.texture1->xend);
        ...
        va->AddVertexQTC(drawPos - (dir1 * size),
                         midtexx,
                         weaponDef->visuals.texture2->ystart,
                         col);
        va->AddVertexQTC(drawPos + (dir1 * size),
                         midtexx,
                         weaponDef->visuals.texture2->yend,
                         col);
        va->AddVertexQTC(drawPos + (dir1 * size) - (dir2 * size),
                         weaponDef->visuals.texture2->xstart,
                         weaponDef->visuals.texture2->yend,
                         col);
        va->AddVertexQTC(drawPos - (dir1 * size) - (dir2 * size),
                         ...
                         weaponDef->visuals.texture2->ystart,
                         col);
        va->AddVertexQTC(drawPos - (dir1 * coresize),
                         midtexx,
                         weaponDef->visuals.texture2->ystart,
                         col2);
        va->AddVertexQTC(drawPos + (dir1 * coresize),
                         ...
                         weaponDef->visuals.texture2->yend,
                         col2);
        va->AddVertexQTC(drawPos + (dir1 * coresize) - (dir2 * coresize),
                         weaponDef->visuals.texture2->xstart,
                         weaponDef->visuals.texture2->yend,
                         col2);
        va->AddVertexQTC(drawPos - (dir1 * coresize) - (dir2 * coresize),
        ...
        va->AddVertexQTC(drawPos - (dir1 * size),
                         weaponDef->visuals.texture1->xstart + texStartOffset,
                         weaponDef->visuals.texture1->ystart,
                         col);
        va->AddVertexQTC(drawPos + (dir1 * size),
                         weaponDef->visuals.texture1->xstart + texStartOffset,
                         weaponDef->visuals.texture1->yend,
                         col);
        va->AddVertexQTC(pos2 + (dir1 * size),
                         weaponDef->visuals.texture1->xend + texEndOffset,
                         weaponDef->visuals.texture1->yend,
                         col);
        va->AddVertexQTC(pos2 - (dir1 * size),
                         weaponDef->visuals.texture1->xend + texEndOffset,
        ...
        va->AddVertexQTC(drawPos + (dir1 * coresize),
                         ...
                         weaponDef->visuals.texture1->yend,
                         col2);
        va->AddVertexQTC(pos2 + (dir1 * coresize),
                         weaponDef->visuals.texture1->xend + texEndOffset,
                         weaponDef->visuals.texture1->yend,
                         col2);
        va->AddVertexQTC(pos2 - (dir1 * coresize),
        ...
        va->AddVertexQTC(pos2 + (dir1 * size),
                         ...
                         weaponDef->visuals.texture2->yend,
                         col);
        va->AddVertexQTC(pos2 + (dir1 * size) + (dir2 * size),
                         weaponDef->visuals.texture2->xend,
                         weaponDef->visuals.texture2->yend,
                         col);
        va->AddVertexQTC(pos2 - (dir1 * size) + (dir2 * size),
        ...
        va->AddVertexQTC(pos2 + (dir1 * coresize),
                         ...
                         weaponDef->visuals.texture2->yend,
                         col2);
        va->AddVertexQTC(pos2 + (dir1 * coresize) + (dir2 * coresize),
                         weaponDef->visuals.texture2->xend,
                         weaponDef->visuals.texture2->yend,
                         col2);
        va->AddVertexQTC(pos2 - (dir1 * coresize) + (dir2 * coresize),
        ...
        va->AddVertexQTC(pos1 - (dir1 * size),
                         weaponDef->visuals.texture1->xstart + texStartOffset,
                         weaponDef->visuals.texture1->ystart,
                         col);
        va->AddVertexQTC(pos1 + (dir1 * size),
        ...
        va->AddVertexQTC(pos2 - (dir1 * size),
                         ...
                         weaponDef->visuals.texture1->ystart,
                         col);
        va->AddVertexQTC(pos1 - (dir1 * coresize),
                         weaponDef->visuals.texture1->xstart + texStartOffset,
                         weaponDef->visuals.texture1->ystart,
                         col2);
        va->AddVertexQTC(pos1 + (dir1 * coresize),
