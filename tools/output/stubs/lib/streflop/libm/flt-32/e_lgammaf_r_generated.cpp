...
#endif
{
    ...
    switch (n) {
        ...
        case 1:
        case 2:
            y = __kernel_cosf(pi * ((Simple)0.5f - y), zero);
            break;
        case 3:
        case 4:
        ...
        case 5:
        case 6:
            y = -__kernel_cosf(pi * (y - (Simple)1.5f), zero);
            break;
        default:
            y = __kernel_sinf(pi * (y - (Simple)2.0f), zero, 0);
            break;
    }
    return -y;
}
...
#endif
{
    ...
    *signgamp = 1;
    ...
    /* for x < 2.0f */
        ...
        switch (i) {
            case 7:
                z *= (y + (Simple)6.0f); /* FALLTHRU */
            case 6:
                z *= (y + (Simple)5.0f); /* FALLTHRU */
            case 5:
                z *= (y + (Simple)4.0f); /* FALLTHRU */
            case 4:
                z *= (y + (Simple)3.0f); /* FALLTHRU */
            case 3:
