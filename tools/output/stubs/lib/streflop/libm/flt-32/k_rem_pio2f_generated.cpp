...
static char rcsid[] =
  "$NetBSD: k_rem_pio2f.c,v 1.4f 1995/05/10 20:46:28 jtc Exp $";
#endif
...
recompute:
    ...
    z -=
      (Simple)8.0f * __floorf(z * (Simple)0.125f); /* trim off integer >= 8 */
    n = (int32_t)z;
    z -= (Simple)n;
    ih = 0;
