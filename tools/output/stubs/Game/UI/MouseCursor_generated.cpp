...
CMouseCursor::Draw(int x, int y, float scale) const
{
    ...
    static float vertices[] = { 0.f, 0.f, 0.f, 0.f, 1.f, 0.f,
                                1.f, 1.f, 0.f, 1.f, 0.f, 0.f };
    static float texcoords[] = { 0.f, 0.f, 0.f, 1.f, 1.f, 1.f, 1.f, 0.f };
...
CMouseCursor::Update()
{
    ...
    animTime = math::fmod(animTime + globalRendering->lastFrameTime * 0.001f,
                          animPeriod);
