...
CIconHandler::CIconHandler()
{
    ...
    if (it != iconMap.end()) {
        ...
        defIconData = new CIconData(
          "default", GetDefaultTexture(), 1.0f, 1.0f, false, false, 128, 128);
                      ...
                      bool radAdj)
{
    ...
    try {
        ...
        if (!textureName.empty() && bitmap.Load(textureName)) {
            ...
            const GLenum wrapMode =
              GLEW_EXT_texture_edge_clamp ? GL_CLAMP_TO_EDGE : GL_CLAMP;
    ...
    CIconData* iconData = new CIconData(
      iconName, texID, size, distance, radAdj, ownTexture, xsize, ysize);
