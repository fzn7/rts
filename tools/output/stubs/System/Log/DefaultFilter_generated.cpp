...
{
    const char* section_cstr =
      log_filter_section_getSectionCString(section_cstr_tmp);
...
log_filter_section_getRegisteredSet()
{
    ...
    std::set<const char*> outSet(registeredSections.begin(),
                                 registeredSections.end());
    return outSet;
}
