...
{
    const float3 speed = ((weaponDef->fixedLauncher) ? weaponDir : UpVector) *
    ...
    params.maxRange = (weaponDef->flighttime > 0 || weaponDef->fixedLauncher)
                                       ...
                                       bool useMuzzle) const
{
    ...
    if (TraceRay::TestCone(weaponMuzzlePos,
                           wdir,
                           100.0f,
                           0.0f,
                           owner->allyteam,
