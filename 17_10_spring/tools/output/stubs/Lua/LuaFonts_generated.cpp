...
LuaFonts::SetTextColor(lua_State* L)
{
    ...
    if (args < 2) {
        luaL_error(L,
                   "Incorrect arguments to font:SetTextColor([\"textColor\"])");
    }
    ...
    if (lua_istable(L, 2)) {
        ...
        if (count < 3) {
            luaL_error(
              L, "Incorrect arguments to font:SetTextColor([\"textColor\"])");
        }
        if (count == 3) {
            color->w = 1.0f;
        }
...
LuaFonts::SetOutlineColor(lua_State* L)
{
    ...
    if (args < 2) {
        luaL_error(
          L, "Incorrect arguments to font:SetOutlineColor([\"outlineColor\"])");
    }
