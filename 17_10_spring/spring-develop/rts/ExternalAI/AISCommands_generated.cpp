...
toInternalUnitCommandTopic(int aiCmdTopic, const void* sUnitCommandData)
{
    ...
    switch (aiCmdTopic) {
        case COMMAND_UNIT_BUILD: {
            const SBuildUnitCommand* cmd =
              reinterpret_cast<const SBuildUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_CUSTOM: {
            const SCustomUnitCommand* cmd =
              reinterpret_cast<const SCustomUnitCommand*>(sUnitCommandData);
    ...
    switch (sCommandId) {
        case COMMAND_UNIT_BUILD: {
            SBuildUnitCommand* cmd =
              static_cast<SBuildUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_STOP: {
            SStopUnitCommand* cmd =
              static_cast<SStopUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_WAIT: {
            SWaitUnitCommand* cmd =
              static_cast<SWaitUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_WAIT_TIME: {
            STimeWaitUnitCommand* cmd =
              static_cast<STimeWaitUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_WAIT_DEATH: {
            SDeathWaitUnitCommand* cmd =
              static_cast<SDeathWaitUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_WAIT_SQUAD: {
            SSquadWaitUnitCommand* cmd =
              static_cast<SSquadWaitUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_WAIT_GATHER: {
            SGatherWaitUnitCommand* cmd =
              static_cast<SGatherWaitUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_MOVE: {
            SMoveUnitCommand* cmd =
              static_cast<SMoveUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_PATROL: {
            SPatrolUnitCommand* cmd =
              static_cast<SPatrolUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_FIGHT: {
            SFightUnitCommand* cmd =
              static_cast<SFightUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_ATTACK: {
            SAttackUnitCommand* cmd =
              static_cast<SAttackUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_ATTACK_AREA: {
            SAttackAreaUnitCommand* cmd =
              static_cast<SAttackAreaUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_GUARD: {
            SGuardUnitCommand* cmd =
              static_cast<SGuardUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_GROUP_ADD: {
            SGroupAddUnitCommand* cmd =
              static_cast<SGroupAddUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_GROUP_CLEAR: {
            SGroupClearUnitCommand* cmd =
              static_cast<SGroupClearUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_REPAIR: {
            SRepairUnitCommand* cmd =
              static_cast<SRepairUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_SET_FIRE_STATE: {
            SSetFireStateUnitCommand* cmd =
              static_cast<SSetFireStateUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_SET_MOVE_STATE: {
            SSetMoveStateUnitCommand* cmd =
              static_cast<SSetMoveStateUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_SET_BASE: {
            SSetBaseUnitCommand* cmd =
              static_cast<SSetBaseUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_SELF_DESTROY: {
            SSelfDestroyUnitCommand* cmd =
              static_cast<SSelfDestroyUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_SET_WANTED_MAX_SPEED: {
            SSetWantedMaxSpeedUnitCommand* cmd =
              static_cast<SSetWantedMaxSpeedUnitCommand*>(sUnitCommandData);
            *c = Command(
              CMD_SET_WANTED_MAX_SPEED, cmd->options, cmd->wantedMaxSpeed);
            c->timeOut = cmd->timeOut;
        } break;

        case COMMAND_UNIT_LOAD_UNITS: {
            SLoadUnitsUnitCommand* cmd =
              static_cast<SLoadUnitsUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_LOAD_UNITS_AREA: {
            SLoadUnitsAreaUnitCommand* cmd =
              static_cast<SLoadUnitsAreaUnitCommand*>(sUnitCommandData);
            *c = Command(CMD_LOAD_UNITS, cmd->options);
            c->timeOut = cmd->timeOut;
        ...
        case COMMAND_UNIT_LOAD_ONTO: {
            SLoadOntoUnitCommand* cmd =
              static_cast<SLoadOntoUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_UNLOAD_UNITS_AREA: {
            SUnloadUnitsAreaUnitCommand* cmd =
              static_cast<SUnloadUnitsAreaUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_UNLOAD_UNIT: {
            SUnloadUnitCommand* cmd =
              static_cast<SUnloadUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_SET_ON_OFF: {
            SSetOnOffUnitCommand* cmd =
              static_cast<SSetOnOffUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_RECLAIM_UNIT: {
            SReclaimUnitUnitCommand* cmd =
              static_cast<SReclaimUnitUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_RECLAIM_FEATURE: {
            SReclaimFeatureUnitCommand* cmd =
              static_cast<SReclaimFeatureUnitCommand*>(sUnitCommandData);
            *c = Command(
              CMD_RECLAIM, cmd->options, maxUnits + cmd->toReclaimFeatureId);
            c->timeOut = cmd->timeOut;
        } break;

        case COMMAND_UNIT_RECLAIM_AREA: {
            SReclaimAreaUnitCommand* cmd =
              static_cast<SReclaimAreaUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_CLOAK: {
            SCloakUnitCommand* cmd =
              static_cast<SCloakUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_STOCKPILE: {
            SStockpileUnitCommand* cmd =
              static_cast<SStockpileUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_D_GUN: {
            ...
            SDGunUnitCommand* cmd =
              static_cast<SDGunUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_D_GUN_POS: {
            ...
            SDGunPosUnitCommand* cmd =
              static_cast<SDGunPosUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_RESTORE_AREA: {
            SRestoreAreaUnitCommand* cmd =
              static_cast<SRestoreAreaUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_SET_REPEAT: {
            SSetRepeatUnitCommand* cmd =
              static_cast<SSetRepeatUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_SET_TRAJECTORY: {
            SSetTrajectoryUnitCommand* cmd =
              static_cast<SSetTrajectoryUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_RESURRECT: {
            SResurrectUnitCommand* cmd =
              static_cast<SResurrectUnitCommand*>(sUnitCommandData);
            *c =
              Command(CMD_RESURRECT, cmd->options, cmd->toResurrectFeatureId);
            c->timeOut = cmd->timeOut;
        } break;

        case COMMAND_UNIT_RESURRECT_AREA: {
            SResurrectAreaUnitCommand* cmd =
              static_cast<SResurrectAreaUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_CAPTURE: {
            SCaptureUnitCommand* cmd =
              static_cast<SCaptureUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_CAPTURE_AREA: {
            SCaptureAreaUnitCommand* cmd =
              static_cast<SCaptureAreaUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_SET_AUTO_REPAIR_LEVEL: {
            SSetAutoRepairLevelUnitCommand* cmd =
              static_cast<SSetAutoRepairLevelUnitCommand*>(sUnitCommandData);
            *c =
              Command(CMD_AUTOREPAIRLEVEL, cmd->options, cmd->autoRepairLevel);
            c->timeOut = cmd->timeOut;
        } break;

        case COMMAND_UNIT_SET_IDLE_MODE: {
            SSetIdleModeUnitCommand* cmd =
              static_cast<SSetIdleModeUnitCommand*>(sUnitCommandData);
        ...
        case COMMAND_UNIT_CUSTOM: {
            SCustomUnitCommand* cmd =
              static_cast<SCustomUnitCommand*>(sUnitCommandData);
