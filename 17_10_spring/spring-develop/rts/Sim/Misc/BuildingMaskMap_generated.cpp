...
bool
BuildingMaskMap::CheckBounds(unsigned int x, unsigned int z)
{
...
bool
BuildingMaskMap::SetTileMask(unsigned int x,
                             unsigned int z,
...
// tests previously set mask for tile[x,z] in 2*SQUARE_SIZE coordinates against
// supplied value true - construction is allowed, false - it's not
bool
BuildingMaskMap::TestTileMaskUnsafe(unsigned int x,
                                    unsigned int z,
                                    boost::uint16_t value)
{
