...
*/
float
CMoveMath::HoverSpeedMod(const MoveDef& moveDef, float height, float slope)
{
...
float
CMoveMath::HoverSpeedMod(const MoveDef& moveDef,
                         float height,
                         float slope,
                         float dirSlopeMod)
{
    ...
    return (1.0f /
            (1.0f + std::max(0.0f, slope * dirSlopeMod) * moveDef.slopeMod));
}
